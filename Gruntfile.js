...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        browserify: {
            prod: {
                files: {
                    './webapp.build/js/consumer.js': ['./client/js/consumer.js']
                }
            }
        },
        ...
        sass: {
            prod: {
                ...
                files: {
                    './webapp.build/css/consumer.css': ['./client/sass/consumer.scss']
                }
            },
        ...
        autoprefixer: {
            prod: {
                files: {
                    './webapp.build/css/consumer.css': './webapp.build/css/consumer.css'
                }
            }
        },
        ...
        uglify: {
            prod: {
                ...
                files: {
                    './webapp.build/js/consumer.min.js': ['./webapp.build/js/consumer.js']
                }
            }
        },
        ...
        cssmin: {
            prod: {
                ...
                files: {
                    './webapp.build/css/consumer.min.css': ['./webapp.build/css/consumer.css']
                }
            }
        },
